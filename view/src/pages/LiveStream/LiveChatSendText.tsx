...
interface LiveChatSendTextProps {
  roomId: any;
}

const LiveChatSendText: React.FC<LiveChatSendTextProps> = ({ roomId }) => {
  ...
  const handleSend = async () => {
    if (message.trim()) {
      try {
        const response = await chatServices.sendMessage(roomId, userId, message);
