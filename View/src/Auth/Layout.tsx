        ...
        <div className="flex flex-col items-center justify-center relative w-full h-screen max-w-[414px] max-h-[896px]">
            <div className="w-full h-full flex flex-col justify-between p-8">
                ...
                <div className="flex justify-between space-x-2.5">
                    ...
                    {/* <div className="w-1/2 h-[53px] bg-[#F5F6FA] rounded-[5px] flex items-center justify-center text-[14px] font-medium text-[#151940] tracking-[2.55px]">GOOGLE</div>
          <div className="w-1/2 h-[53px] bg-[#F5F6FA] rounded-[5px] flex items-center justify-center text-[14px] font-medium text-[#151940] tracking-[2.55px]">FACEBOOK</div> */}
                </div>

                <div className="flex flex-col items-start mt-8 text-center">
                    <p className="text-[14px] text-[#151940] mb-5">Already have an account?</p>
                    <a href="/sign-in" className="text-[16px] text-[#314BCE] font-bold tracking-[2.55px] flex items-center justify-center">
                        LOGIN <img src="../system/icons/go.svg" alt="" className="ml-2.5 w-[15px] h-[15px]" />
                    </a>
                </div>
            </div>
        </div>)
